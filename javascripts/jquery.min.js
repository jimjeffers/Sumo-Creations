...
$(document).ready(function(){$("body").addClass("advanced");var a=$("div#content section");buildMatrix(a);$(window).resize(function(){buildMatrix(a)})});function buildMatrix(b){var a={cellHeight:$(window).height(),cellWidth:$(window).width(),size:b.size()};b.each(function(c){$(this).css("left",c*a.cellWidth)})};