...
$(document).ready(function(){$("body").addClass("advanced");var a=$("div#content section");buildMatrix(a);$(window).resize(function(){buildMatrix(a)});a.click(function(){var b=$(this).next().get(0);if(b){$("body").scrollTo(b,800)}else{$("body").scrollTo($(this).siblings().get(0),800)}})});function buildMatrix(b){var a={cellHeight:$(window).height(),cellWidth:$(window).width(),size:b.size()};b.each(function(c){$(this).css("left",c*a.cellWidth)})};